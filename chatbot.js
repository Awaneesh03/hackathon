    ...
    getQuickAnswer(question) {
        const answers = {
            'How does QR pickup work?':
                "It's simple! 1️⃣ Order via the official canteen app 2️⃣ Upload your QR screenshot on CampusDash 3️⃣ Our dasher picks it up using your QR 4️⃣ Get it delivered to your location! 🎉",
        ...
        return answers[question] || "I'm here to help! Ask me anything about CampusDash.";
    }
    ...
    async sendToLLM(message) {
        ...
        const response = await fetch('https://api.openai.com/v1/chat/completions', {
            ...
            body: JSON.stringify({
                model: 'gpt-3.5-turbo',
                messages: [
                    { role: 'system', content: 'You are DashBot, a helpful assistant for CampusDash delivery platform.' },
        ...
        */
        ...
        const response = await fetch('https://generativelanguage.googleapis.com/v1/models/gemini-pro:generateContent', {
            ...
            body: JSON.stringify({
                contents: [{
                    parts: [{
                        text: `You are DashBot for CampusDash. ${message}`
                    }]
                }]
            })
        });
